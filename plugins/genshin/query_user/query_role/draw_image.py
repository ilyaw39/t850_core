...
def get_user_data_image(
    ...
    region = BuildImage(1440, 450, color="#E3DBD1", font="NotoSerifSC-Bold.otf")
    ...
    data_img = BuildImage(
        800, 400, color="#E3DBD1", font="NotoSerifSC-Bold.otf", font_size=40
    )
    _height = 0
    keys = [
        ["活跃天数", "成就达成", "获得角色", "深境螺旋"],
    ...
    for key, value in zip(keys, values):
        _tmp_data_img = BuildImage(
            800, 200, color="#E3DBD1", font="NotoSerifSC-Bold.otf", font_size=40
        )
        _width = 10
        for k, v in zip(key, value):
            ...
            tmp_ = BuildImage(
                t_.w, t_.h + 70, color="#E3DBD1", font="NotoSerifSC-Bold.otf", font_size=40
            )
...
def get_home_data_image(home_data_list: List[Dict]) -> BuildImage:
    ...
    h = 130 + 300 * 4
    region = BuildImage(
        550, h, color="#E3DBD1", font="NotoSerifSC-Bold.otf", font_size=40
    )
    try:
        region.text(
    ...
    for i, file in enumerate(homes):
        ...
        if file.split(".")[0] not in unlock_home:
            ...
            black_img = BuildImage(
                500, 150, color="black", font="NotoSerifSC-Bold.otf", font_size=40
            )
...
def get_country_data_image(world_data_dict: Dict) -> BuildImage:
    ...
    for country in ["蒙德", "龙脊雪山", "璃月", "层岩巨渊", "稻妻", "渊下宫"]:
        ...
        content_bk = BuildImage(
            755, 215, color="#3A4467", font_size=40, font="NotoSerifSC-Bold.otf"
        )
