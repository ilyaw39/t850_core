...
def create_border(
    ...
    border = BuildImage(500, 100, color="#E0D9D1", font="NotoSerifSC-Bold.otf", font_size=20)
    text_bk = BuildImage(350, 96, color="#F5F1EB", font_size=23, font="NotoSerifSC-Bold.otf")
...
def _parse_data_and_draw(
    ...
    A = BuildImage(1030, 520, color="#f1e9e1", font_size=15, font="NotoSerifSC-Bold.otf")
    A.text((10, 15), "原神便笺 | Create By ZhenXun", (198, 186, 177))
    ava = BuildImage(100, 100, background=user_avatar)
    ava.circle()
    A.paste(ava, (40, 40), True)
    A.paste(
        BuildImage(0, 0, plain_text=uname, font_size=20, font="NotoSerifSC-Bold.otf"),
        (160, 62),
        True,
    )
    A.paste(
    ...
    expeditions_border = BuildImage(
        470, 430, color="#E0D9D1", font="NotoSerifSC-Bold.otf", font_size=20
    )
    expeditions_text = BuildImage(
        466, 426, color="#F5F1EB", font_size=23, font="NotoSerifSC-Bold.otf"
    )
    ...
    for x in expeditions:
        _bk = BuildImage(400, 66, color="#ECE3D8", font="NotoSerifSC-Bold.otf", font_size=21)
        file_name = x["avatar_side_icon"].split("_")[-1]
        role_avatar = memo_path / "role_avatar" / file_name
