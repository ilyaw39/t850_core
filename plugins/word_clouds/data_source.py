...
async def draw_word_cloud(messages, config):
    ...
    wordcloud_ttf = FONT_PATH / "NotoSerifSC-Bold.otf"
    ...
    if not wordcloud_ttf.exists():
        ttf_url = "https://ghproxy.com/https://raw.githubusercontent.com/HibiKier/zhenxun_bot/main/resources/font/NotoSerifSC-Bold.otf"
        try:
